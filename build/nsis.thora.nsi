...
# 1. install thora for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for thora
# 5. create thora, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable THORA_SOCKET
...
!define GROUPNAME "Thora Network"
!define APPNAME "Thora"
!define DESCRIPTION "Official Go implementation of the Thora protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since thora is installed global
